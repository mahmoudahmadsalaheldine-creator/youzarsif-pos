...
- `users`: staff accounts with role and optional store assignment (`location_id`)
...
3. Copy `config/database.example.php` to `config/database.php` and fill in your DB credentials
4. Copy `config/mail.example.php` to `config/mail.php` and fill in your SMTP credentials
